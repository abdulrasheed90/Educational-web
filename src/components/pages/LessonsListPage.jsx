  ...
  return <div className="min-h-screen py-20 px-4">
    <div className="max-w-6xl mx-auto">
      <motion.div initial={{
        ...
        <Link to={backLink} className="inline-flex items-center text-white hover:text-white/80 transition-colors mb-8">
        ...
        {lessons.map((lesson, index) => {
          ...
          return <motion.div key={lessonId} initial={{
            ...
            <Link to={`/lesson/${lessonId}`} className="block group h-full">
              <div className="bg-gradient-to-br from-[#111113] to-[#111113]/50 border border-white/10 rounded-2xl p-6 h-full hover:border-white/30 transition-all duration-300 hover:shadow-xl flex flex-col">
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#11282b] to-[#06b5cc] flex items-center justify-center mb-4 shadow-lg shadow-[#06b5cc]/10">
                  <FileText className="w-6 h-6 text-white" />
                </div>

                <h3 className="mb-3 group-hover:text-[#EADADA] transition-colors duration-300">
                  {lesson.title}
                </h3>
                ...
                <div className="flex items-center text-[#06b5cc] group-hover:text-white transition-colors duration-300 text-sm">
