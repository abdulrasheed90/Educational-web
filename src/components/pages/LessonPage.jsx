    ...
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{
          ...
          <button onClick={() => navigate(-1)} className="inline-flex rounded-lg px-3 items-center text-[#94A3B8] hover:text-white transition-colors mb-8">
        ...
        <motion.div initial={{
          ...
          duration: 0.6,
          delay: 0.2
        }} className="bg-gradient-to-br from-[#111113] to-[#111113]/50 border border-white/10 rounded-2xl overflow-hidden mb-8">
          <div className="p-8">
            ...
            {(isPremium && user && token) ? (
                ...
                <div className="prose prose-invert max-w-none">
                  <div className="bg-[#0A0E14] rounded-xl p-6 border border-white/5">
                    {lessonNotes.content ? (
                      ...
                      <>
                        <h3 className="text-[#EADADA] mb-4">Introduction</h3>
                        ...
                        {lessonNotes.content && (
                          <>
                            <h3 className="text-[#EADADA] mb-4 mt-6">Key Concepts</h3>
                            <div
                              className="text-[#94A3B8]"
                              dangerouslySetInnerHTML={{ __html: lessonNotes.content }}
                            />
                        ...
                        <div className="mt-6 p-4 bg-[#06b5cc]/10 border border-[#06b5cc]/30 rounded-lg">
                          <p className="text-[#EADADA] text-sm">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-transparent via-[#111113]/80 to-[#111113]">
                  <div className="text-center p-8">
                    ...
                    <button
                      ...
                      className="inline-block px-8 py-3 bg-gradient-to-r from-[#F7C94C] to-[#06b5cc] hover:opacity-90 rounded-xl transition-all duration-300 shadow-lg shadow-[#06b5cc]/10"
                    >
                      Login Now
                    </button>
                  </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-transparent via-[#111113]/80 to-[#111113]">
                  <div className="text-center p-8">
                    ...
                    <button
                      ...
                      className="inline-block px-8 py-3 bg-gradient-to-r from-[#F7C94C] to-[#06b5cc] hover:opacity-90 rounded-xl transition-all duration-300"
                    >
                      Upgrade to Premium
                    </button>
                  </div>
        ...
        <motion.div initial={{
          ...
          <Link to={`/lesson/${lessonId}/questions`} className="block group">
            <div className="bg-gradient-to-br from-[#06b5cc]/20 to-[#F7C94C]/20 border border-[#06b5cc]/30 rounded-2xl p-8 hover:border-[#06b5cc]/50 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-center justify-between">
                ...
                <svg className="w-8 h-8 text-[#06b5cc] group-hover:translate-x-2 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
