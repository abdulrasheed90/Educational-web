          ...
          {submitted ? <div className="text-center">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@email.com" required className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-[#06b5cc] transition-colors" />
              </div>
            </div>
