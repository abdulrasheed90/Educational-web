...
export default function PrivacyPolicyPage() {
  ...
  const policyContent = settings.policies?.privacyPolicy?.content;
  const lastUpdated = settings.policies?.privacyPolicy?.lastUpdated || 'January 2025';
        ...
        >
          ...
          <div className="text-center mb-12">
            <div className="inline-flex h-8 items-center gap-3 px-6 py-2.5 bg-[#06b5cc]/10 border border-[#06b5cc]/20 rounded-full mb-8 mx-auto mt-4 hover:bg-[#06b5cc]/15 transition-colors duration-300">
              <Shield className="w-6 h-6 text-[#06b5cc]" />
              <span className="text-sm font-bold uppercase tracking-[0.2em] text-[#06b5cc]">Privacy Policy</span>
            </div>
            ...
            {policyContent ? (
              ...
              <section className="bg-gradient-to-br from-[#111113] to-[#111113]/50 border border-white/10 rounded-2xl p-12 text-center">
                ...
                <p className="text-[#94A3B8]">
                  The privacy policy content has not been added yet. Please configure it from the admin dashboard.
                </p>
              </section>
            )}
          </div>
