...
export default function SectionsPage() {
    ...
    return (
      <div className="min-h-screen py-20 px-4 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <Link
            to="/subjects"
            className="inline-block px-6 py-3 bg-primary-gradient rounded-xl transition-colors shadow-lg shadow-[#06b5cc]/10"
          >
            Back to Subjects
          </Link>
        </div>
  ...
  if (sections.length === 0 && !loading) {
    return (
      <div className="min-h-screen py-20 px-4 flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-12 h-12 text-[#06b5cc] animate-spin mx-auto mb-4" />
  ...
  return <div className="min-h-screen py-20 px-4">
    <div className="max-w-6xl mx-auto">
      <motion.div initial={{
        ...
        <Link to="/subjects" className="inline-flex items-center text-white hover:text-white/80 transition-colors mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {sections.map((section, index) => {
          ...
          return <motion.div key={sectionId} initial={{
            ...
            >
              <div className={`bg-gradient-to-br from-[#111113] to-[#111113]/50 border ${isPremium && !userIsPremium ? 'border-[#F7C94C]/50' : 'border-white/10'} rounded-2xl p-8 hover:border-white/30 transition-all duration-300 hover:shadow-xl`}>
                <div className="flex items-start">
                  <div className={`w-14 h-14 rounded-xl ${isPremium && !userIsPremium ? 'bg-gradient-to-br from-[#F7C94C] to-[#F7C94C]/80' : 'bg-gradient-to-br from-[#11282b] to-[#0a1f22]'} flex items-center justify-center flex-shrink-0`}>
                  ...
                  <div className="ml-6 flex-1">
                    ...
                    <div className="mt-4 flex items-center text-[#06b5cc] group-hover:text-white transition-colors duration-300">
